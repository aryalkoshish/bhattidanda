	...
	<section class="content">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="{{route('view.package')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="{{route('booking.view')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="{{route('booking.replies')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="{{route('booked.view')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
		...
		<div class="row">
			...
			<section class="col-lg-7 connectedSortable">
				...
				<div class="box box-info">
					...
					<div class="box-body">
						<form action="{{route('quick.reply')}}" method="post">
							{{csrf_field()}}
                ...
                <tr>
                  ...
                  @endforeach
					...
					<div class="box-footer text-center">
						<a href="{{route('view.quickreply')}}" class="uppercase">View All Quick mails</a>
					</div>
					<!-- /.box-footer -->
				</div>
				<!-- Calendar -->
