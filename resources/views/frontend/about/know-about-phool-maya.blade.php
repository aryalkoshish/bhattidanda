...
<div class="container-fluid mayaimage packageimg">
	<img src="{{asset('image_upload/'.$about->image)}}" class="img-responsive " alt="Phool Maya">
</div>
...
<div class="container maya-pad">
	<div class="col-md-6 text-center">
		<a href="{{asset('fileupload/'.$about->pdf_file)}}" target="_blank"><button type="button" class="btn btn-warning btn-maya"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>PDF FILE</button></a>
	</div>

	<div class="col-md-6 text-center">
		<a href="{{$about->video_link}}" target="_blank"><button type="button" class="btn btn-warning btn-maya"><i class="fa fa-female" aria-hidden="true"></i>KNOW ABOUT PHOOL MAYA</button></a>
	</div>
</div>
